document.addEventListener('DOMContentLoaded', function () {
    ...
    function drawAllArrow(){
        ...
        drawArrow(document.getElementById('person4'), document.getElementById('person5'));
        drawArrow(document.getElementById('person4'), document.getElementById('person6'));
        drawArrow(document.getElementById('person4'), document.getElementById('person7'));
    }
